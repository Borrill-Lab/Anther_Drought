...
setwd("~/Desktop/RNASeq_data_analysis_files/kallisto_results")
write.table(txi$counts, file="Anther_lines_count.tsv")
write.table(txi$abundance, file="Anther_lines_tpm.tsv")
...
write.csv(gene_lengths, file="Anther_gene_lengths.csv")
